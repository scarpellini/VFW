sub vcl_recv {
	if (!req.http.X-VFW-Static) {
		...
		if (req.url ~ "(?i)(\s|%20|\t|%09|\+)+(OR|AND)(\s|%20|\t|%09|\+)+(\'|%27|%22)?(\s|%20|\t|%09|\+)*\d+(\s|%20|\t|%09|\+)*(\'|%27|%22)?(\s|%20|\t|%09|\+)*(=|%3D)(\s|%20|\t|%09|\+)*(\'|%27|%22)?(\s|%20|\t|%09|\+)*\d+") {
			set req.http.X-VFW-Threat = "SQL Injection";
		...
		if (req.http.X-VFW-Body) {
			...
			if (req.http.X-VFW-Body ~ "(?i)(\s|%20|\t|%09|\+)+(OR|AND)(\s|%20|\t|%09|\+)+(\'|%27|%22)?(\s|%20|\t|%09|\+)*\d+(\s|%20|\t|%09|\+)*(\'|%27|%22)?(\s|%20|\t|%09|\+)*(=|%3D)(\s|%20|\t|%09|\+)*(\'|%27|%22)?(\s|%20|\t|%09|\+)*\d+") {
				set req.http.X-VFW-Threat = "SQL Injection";
